...
import { BarChart3, Users, MessageSquare, Globe, Shield, Zap, Database, CheckCircle, AlertCircle, RefreshCw, LogOut, User, Settings, Bell } from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button 
                ...
                className="flex items-center space-x-1 text-sm text-gray-600 hover:text-blue-600 transition-colors p-2 rounded-lg hover:bg-blue-50"
              >
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-blue-50 to-indigo-50 px-4 py-2 rounded-full mb-4">
            ...
            <span className="text-sm font-medium text-blue-600">Welcome back, {currentUser.user_metadata?.name || currentUser.email}</span>
          </div>
                  ...
                  {!cookieStatus.hasCookies && (
                    <div className="mt-3">
                      ...
                      <div className="bg-gray-800 text-gray-100 p-3 rounded-lg font-mono text-sm overflow-x-auto">
                        INSERT INTO linkedin_profile_data (name, li_at, jsessionid, bcookie, is_active, user_id) <br />
                        VALUES ('Your Name', 'li_at_cookie_value', 'jsessionid_value', 'bcookie_value', true, '{currentUser.id}');
                      </div>
                    </div>
                  )}
                </div>
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              ...
              <p className="text-gray-600 text-sm mt-2">Logged in as: {currentUser.email}</p>
            </div>
          ...
          <div className="text-center text-gray-500 text-sm mt-6 pt-6 border-t border-gray-100">
            © {new Date().getFullYear()} LinkedIn Analyzer. User: {currentUser.email}
          </div>
        </div>
      </footer>
    </div>
